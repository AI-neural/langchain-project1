...
st.title('Know Your Idol')
input_text=st.text_input("Search for any of Your Favorite Celebrity")
...
fourth_input_prompt = PromptTemplate(
    input_variables=['dob'],
    template="Mention the name of family members of celebrity {dob}"
)
...
parent_chain = SequentialChain(
    ...
    input_variables=['name'],
    output_variables=['person', 'dob', 'description', 'family'],
    verbose=True
)
